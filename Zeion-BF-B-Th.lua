...
local Main = Tabs.Main:AddSection("ฟาร์มมอน")
...
local Toggle = Tabs.TP:AddToggle("Auto Teleport To Select Island", {
    Title = "เทเลพอร์ตไปยังเกาะ [Selection]", 
