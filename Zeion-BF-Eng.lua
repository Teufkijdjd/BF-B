...
ImageButton.Image = "rbxassetid://109388351613854"
...
Notification.new("<Color=Cyan>Zeion HUB<Color=/>"):Display()
wait(0.5)
Notification.new("<Color=Cyan>Zeion HUB https://discord.gg/gHcY98bmRV<Color=/>"):Display()
wait(0.5)
Notification.new("<Color=White>By x2NYXZRLz<Color=/>"):Display()

_G.HoHoLoaded = true

local notify = loadstring(game:HttpGet("https://raw.githubusercontent.com/acsu123/HOHO_H/main/Notification.lua"))()

notify.New("Zeion Hub", 5)
notify.New("By x2NYXZRLz", 5)

local Window = Fluent:CreateWindow({
    Title = "Zeion Hub | Blox fruits",
    SubTitle = "By x2NYXZRLz",
    TabWidth = 100,
...
local Tabs = {
    Main = Window:AddTab({ Title = "Main", Icon = "rbxassetid://15712703260" }),
    IQ = Window:AddTab({ Title = "Item & Quest", Icon = "swords" }),
    Ea = Window:AddTab({ Title = "Race V4", Icon = "chevrons-up" }),
...
spawn(function()
   ...
   local Toggle = Tabs.Main:AddToggle("Auto Farm Level Fruit Mastery", {
    Title = "Auto Farm Fruit Mastery + Farm Level", 
    Description = "",
    Default = false,
    Callback = function(Value)
...
local Main = Tabs.Main:AddSection("Third - Second Sea Quest")
local Toggle = Tabs.Main:AddToggle("Auto Quest World", {
    Title = "Auto Second Sea Quest [Lv. 700]", 
    Description = "",
    Default = false,
    Callback = function(Value)
...
local Toggle = Tabs.Main:AddToggle("Auto Quest World", {
    Title = "Auto Third Sea Quest [Lv. 1500]", 
    Description = "",
    Default = false,
    Callback = function(Value)
...
local Main = Tabs.Main:AddSection("Cake & Katakuri [World 3]")
...
local Toggle = Tabs.Main:AddToggle("Auto Cake Prince Spawner", {
    Title = "Auto Cake Prince Spawner", 
...
local Main = Tabs.Main:AddSection("Bones [World 3]")
...
local Main = Tabs.Main:AddSection("Raid & Law")
...
local Main = Tabs.Main:AddSection("🔋Set mob kill HP% & Skill🪫")
local Slider = Tabs.Main:AddSlider("Kill Monster", {
        Title = "Kill Monster At ..% Health",
        Description = "Kill monsters at ...% HP",
        Default = 30,
        Min = 0,
        Max = 100,
        Rounding = 0,
...
local Main = Tabs.Sg:AddSection("Setting Farm menu")
...
local SelectWeapon = Tabs.Sg:AddDropdown("SelectWeapon", {
    ...
    Values = {"Melee", "Sword", "Gun", "DevilFruit"},
    Multi = false,
    Default = 1,
})
    ...
    while task.wait(1) do
        pcall(function()
            ...
            for _, v in pairs(backpack:GetChildren()) do
                if v:IsA("Tool") then
                    if _G.SelectWeaponType == "Melee" and v.ToolTip == "Melee" then
                        _G.SelectWeapon = v.Name
                        break
                    elseif _G.SelectWeaponType == "Sword" and v.ToolTip == "Sword" then
                        _G.SelectWeapon = v.Name
                        break
                    elseif _G.SelectWeaponType == "Gun" and v.ToolTip == "Gun" then
                        _G.SelectWeapon = v.Name
                        break
                    elseif _G.SelectWeaponType == "DevilFruit" and v.ToolTip == "Blox Fruit" then
                        _G.SelectWeapon = v.Name
                        break
                    end
                end
...
local Main = Tabs.IQ:AddSection("Item Menu")
    ...
    while task.wait() do
        pcall(function()
            if game:GetService("ReplicatedStorage"):FindFirstChild("Diablo") or game:GetService("ReplicatedStorage"):FindFirstChild("Deandre") or game:GetService("ReplicatedStorage"):FindFirstChild("Urban") or game:GetService("Workspace").Enemies:FindFirstChild("Diablo") or game:GetService("Workspace").Enemies:FindFirstChild("Deandre") or game:GetService("Workspace").Enemies:FindFirstChild("Urban") then
                Elite:SetTitle("Elite Hunter: Spawned! ✅")	
            else
                Elite:SetTitle("Elite Hunter: Not Spawned ❌")	
            end
        end)
    end
end)
...
local Toggle = Tabs.IQ:AddToggle("Farm", {
    Title = "Auto Elite Hunter + Hop Server", 
    Description = "", 
    Default = false,
    Callback = function(Value)
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
...
local Main = Tabs.IQ:AddSection("Other Menu")
local Toggle = Tabs.IQ:AddToggle("Auto Greybeard", {
    Title = "Auto White Beard [Level. 750]", 
    Description = "",
    Default = false,
    Callback = function(Value)
...
local Toggle = Tabs.IQ:AddToggle("Auto Forest Pirate & Captain Elephant", {
    Title = "Auto Forest Pirate & Captain Elephant", 
    Description = "",
    Default = false,
    Callback = function(Value)
...
local Main = Tabs.IQ:AddSection("Farm Menu")
...
local Toggle = Tabs.TP:AddToggle("Auto Teleport To Select Island", {
    Title = "Teleport To Select Island [Selection]", 
    Description = "", 
    Default = false,
    Callback = function(Value)
...
Tabs.Shop:AddButton({
    Title = "Buy Iron Mace [$25,000 Beli]",
    Description = "",
    Callback = function()
...
Tabs.Shop:AddButton({
    Title = "Buy Dual Katana [$12,000 Beli]",
    Description = "",
    Callback = function()
...
Tabs.Shop:AddButton({
    Title = "Buy Triple Katana [$60,000 Beli]",
    Description = "",
    Callback = function()
...
Tabs.Shop:AddButton({
    Title = "Buy Dual-Headed Blade [$400,000 Beli]",
    Description = "",
    Callback = function()
...
Tabs.Shop:AddButton({
    Title = "Buy Bisento [$1,200,000 Beli]",
    Description = "",
    Callback = function()
...
Tabs.Shop:AddButton({
    Title = "Buy Soul Cane [$750,000 Beli]",
    Description = "",
    Callback = function()
